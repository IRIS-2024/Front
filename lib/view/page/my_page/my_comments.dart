...
class _MyCommentsState extends State<MyComments> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(title: AppLocalizations.of(context)!.writtenComment),
      body: Obx(
        () => Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text(
                                        '${post.name} / ${Config().getGenderText(post.gender)} / ${post.age} ${AppLocalizations.of(context)!.ageunit} / ${post.address}',
